...
public class triphistory extends AppCompatActivity {
                ...
                builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                     ...
                     //   Walletshare.cadd2 myTask = new Walletshare.cadd2(j);
                      ...
                      //  myTask.execute();
                        Intent intent2 = new Intent(triphistory.this, support.class);
    ...
    private void jlist()
    {
        ...
        try {
            ...
            for (int i = 0; i < jsonArry.length(); i++) {
                ...
                user.put("FullName", obj.getString("source").toUpperCase()+" To "+obj.getString("destination").toUpperCase());
                user.put("Telephone", "FARE :"+obj.getString("fare"));
                user.put("ShareDate", "Date :"+obj.getString("date"));
                userList.add(user);
            }
            ListAdapter adapter = new SimpleAdapter(triphistory.this, userList, R.layout.list_row, new String[]{"id2", "FullName", "Telephone","ShareDate","id"}, new int[]{R.id.id2, R.id.fullname, R.id.Telephone,R.id.ShareDate,R.id.id});
    ...
    private class cSignin extends AsyncTask<String, Void, String> {
        ...
        public void whenSendPostRequest_thenCorrect()
            ...
            String url="https://corellia.co.ke/rider/two.php?action=mytriphistory";
