...
public class walletwithme extends AppCompatActivity {
    String jsonStr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_walletwithme);
...
/*
    ...
    private void jlist()
    {
        ...
        try {
            ...
            ListAdapter adapter = new SimpleAdapter(walletwithme.this, userList, R.layout.list_row, new String[]{"id2", "FullName", "Telephone","ShareDate","id"}, new int[]{R.id.id2, R.id.fullname, R.id.Telephone,R.id.ShareDate,R.id.id});
    ...
    private class cSignin extends AsyncTask<String, Void, String> {
        ...
        public void whenSendPostRequest_thenCorrect()
            ...
            String url="https://corellia.co.ke/rider/two.php?action=walletwithme&d="+cid;
